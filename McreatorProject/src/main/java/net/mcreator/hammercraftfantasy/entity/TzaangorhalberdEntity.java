...
public class TzaangorhalberdEntity extends Monster {
	public final AnimationState animationState0 = new AnimationState();

	public TzaangorhalberdEntity(EntityType<TzaangorhalberdEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public SoundEvent getAmbientSound() {
		return BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("hammercraftfantasy:tzaangor_breath"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
		return BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("hammercraftfantasy:tzaangor_hurt"));
	}

	@Override
	public SoundEvent getDeathSound() {
		return BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("hammercraftfantasy:tzaangor_dead"));
	}
	...
	public void tick() {
		...
		if (this.level().isClientSide()) {
			this.animationState0.animateWhen(Entitys_trytoattack_playanimeProcedure.execute(this), this.tickCount);
		}
	}
