...
@EventBusSubscriber
public class RotmarshLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<RotmarshLeaveDecorator> CODEC = MapCodec.unit(RotmarshLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("hammercraftfantasy:rotmarsh_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public RotmarshLeaveDecorator() {
		super(0.25f);
	}
