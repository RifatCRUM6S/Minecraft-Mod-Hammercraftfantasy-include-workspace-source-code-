...
@EventBusSubscriber
public class RotmarshTrunkDecorator extends TrunkVineDecorator {
	public static MapCodec<RotmarshTrunkDecorator> CODEC = MapCodec.unit(RotmarshTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("hammercraftfantasy:rotmarsh_tree_trunk_decorator"), () -> DECORATOR_TYPE);
	}
