...
import net.mcreator.hammercraftfantasy.procedures.ObsessionanddesiregiveeffectProcedure;
import net.mcreator.hammercraftfantasy.init.HammercraftfantasyModItems;
import net.mcreator.hammercraftfantasy.client.model.Modelobsession_and_desire;
...
@EventBusSubscriber
public abstract class ObsessionanddesireItem extends ArmorItem {
	...
	public static void registerItemExtensions(RegisterClientExtensionsEvent event) {
			...
			public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
				if (armorModel == null) {
					armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(),
							Map.of("head", new Modelobsession_and_desire(Minecraft.getInstance().getEntityModels().bakeLayer(Modelobsession_and_desire.LAYER_LOCATION)).head, "hat", new ModelPart(Collections.emptyList(), Collections.emptyMap()),
		...
		}, HammercraftfantasyModItems.OBSESSIONANDDESIRE_HELMET.get());
		event.registerItem(new IClientItemExtensions() {
			private HumanoidModel armorModel = null;
			...
			public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
				if (armorModel == null) {
					Modelobsession_and_desire model = new Modelobsession_and_desire(Minecraft.getInstance().getEntityModels().bakeLayer(Modelobsession_and_desire.LAYER_LOCATION));
					armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(),
		...
		}, HammercraftfantasyModItems.OBSESSIONANDDESIRE_CHESTPLATE.get());
		event.registerItem(new IClientItemExtensions() {
			private HumanoidModel armorModel = null;
		...
		}, HammercraftfantasyModItems.OBSESSIONANDDESIRE_LEGGINGS.get());
		event.registerItem(new IClientItemExtensions() {
			private HumanoidModel armorModel = null;
		...
		}, HammercraftfantasyModItems.OBSESSIONANDDESIRE_BOOTS.get());
	}

	public ObsessionanddesireItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Chestplate extends ObsessionanddesireItem {
		...
		public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
			...
			if (entity instanceof Player player && Iterables.contains(player.getArmorSlots(), itemstack)) {
				ObsessionanddesiregiveeffectProcedure.execute(world, entity);
			}
		}
	}
