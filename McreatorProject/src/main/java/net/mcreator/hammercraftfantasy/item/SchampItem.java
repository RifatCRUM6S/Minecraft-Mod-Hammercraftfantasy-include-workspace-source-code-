...
import net.mcreator.hammercraftfantasy.procedures.SchampgiveeffectProcedure;
import net.mcreator.hammercraftfantasy.init.HammercraftfantasyModItems;
import net.mcreator.hammercraftfantasy.client.model.Models_champions_armor;
...
@EventBusSubscriber
public abstract class SchampItem extends ArmorItem {
	...
	public static void registerItemExtensions(RegisterClientExtensionsEvent event) {
			...
			public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
				if (armorModel == null) {
					armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(),
							Map.of("head", new Models_champions_armor(Minecraft.getInstance().getEntityModels().bakeLayer(Models_champions_armor.LAYER_LOCATION)).head, "hat", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "body",
		...
		}, HammercraftfantasyModItems.SCHAMP_HELMET.get());
		event.registerItem(new IClientItemExtensions() {
			private HumanoidModel armorModel = null;
			...
			public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
				if (armorModel == null) {
					Models_champions_armor model = new Models_champions_armor(Minecraft.getInstance().getEntityModels().bakeLayer(Models_champions_armor.LAYER_LOCATION));
					armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(),
		...
		}, HammercraftfantasyModItems.SCHAMP_CHESTPLATE.get());
		event.registerItem(new IClientItemExtensions() {
			private HumanoidModel armorModel = null;
		...
		}, HammercraftfantasyModItems.SCHAMP_LEGGINGS.get());
		event.registerItem(new IClientItemExtensions() {
			private HumanoidModel armorModel = null;
		...
		}, HammercraftfantasyModItems.SCHAMP_BOOTS.get());
	}

	public SchampItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Chestplate extends SchampItem {
		...
		public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
			...
			if (entity instanceof Player player && Iterables.contains(player.getArmorSlots(), itemstack)) {
				SchampgiveeffectProcedure.execute(world, entity);
			}
		}
	}
