...
import net.mcreator.hammercraftfantasy.procedures.CorruptionandrotgiveeffectProcedure;
import net.mcreator.hammercraftfantasy.init.HammercraftfantasyModItems;
import net.mcreator.hammercraftfantasy.client.model.Modelcorruption_and_rot;
...
@EventBusSubscriber
public abstract class CorruptionandrotItem extends ArmorItem {
	...
	public static void registerItemExtensions(RegisterClientExtensionsEvent event) {
			...
			public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
				if (armorModel == null) {
					armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(),
							Map.of("head", new Modelcorruption_and_rot(Minecraft.getInstance().getEntityModels().bakeLayer(Modelcorruption_and_rot.LAYER_LOCATION)).head, "hat", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "body",
		...
		}, HammercraftfantasyModItems.CORRUPTIONANDROT_HELMET.get());
		event.registerItem(new IClientItemExtensions() {
			private HumanoidModel armorModel = null;
			...
			public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
				if (armorModel == null) {
					Modelcorruption_and_rot model = new Modelcorruption_and_rot(Minecraft.getInstance().getEntityModels().bakeLayer(Modelcorruption_and_rot.LAYER_LOCATION));
					armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(),
		...
		}, HammercraftfantasyModItems.CORRUPTIONANDROT_CHESTPLATE.get());
		event.registerItem(new IClientItemExtensions() {
			private HumanoidModel armorModel = null;
		...
		}, HammercraftfantasyModItems.CORRUPTIONANDROT_LEGGINGS.get());
		event.registerItem(new IClientItemExtensions() {
			private HumanoidModel armorModel = null;
		...
		}, HammercraftfantasyModItems.CORRUPTIONANDROT_BOOTS.get());
	}

	public CorruptionandrotItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Chestplate extends CorruptionandrotItem {
		...
		public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
			...
			if (entity instanceof Player player && Iterables.contains(player.getArmorSlots(), itemstack)) {
				CorruptionandrotgiveeffectProcedure.execute(world, entity);
			}
		}
	}
