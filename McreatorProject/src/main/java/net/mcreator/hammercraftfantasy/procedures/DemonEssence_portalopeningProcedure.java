...
import net.mcreator.hammercraftfantasy.block.OceanofsoulsPortalBlock;

public class DemonEssence_portalopeningProcedure {
	public static InteractionResult execute(LevelAccessor world, double x, double y, double z, Direction direction) {
		...
		if (world.isEmptyBlock(BlockPos.containing(portalX, portalY, portalZ))) {
			if (world instanceof Level _level)
				OceanofsoulsPortalBlock.portalSpawn(_level, BlockPos.containing(portalX, portalY, portalZ));
