...
import net.mcreator.hammercraftfantasy.block.ChampionsgardenPortalBlock;

public class KeyofgardenopenportalProcedure {
	public static InteractionResult execute(LevelAccessor world, double x, double y, double z, Direction direction) {
		...
		if (world.isEmptyBlock(BlockPos.containing(portalX, portalY, portalZ))) {
			if (world instanceof Level _level)
				ChampionsgardenPortalBlock.portalSpawn(_level, BlockPos.containing(portalX, portalY, portalZ));
