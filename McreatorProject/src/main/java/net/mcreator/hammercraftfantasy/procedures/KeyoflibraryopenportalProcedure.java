...
import net.mcreator.hammercraftfantasy.block.ChampionslibraryPortalBlock;

public class KeyoflibraryopenportalProcedure {
	public static InteractionResult execute(LevelAccessor world, double x, double y, double z, Direction direction) {
		...
		if (world.isEmptyBlock(BlockPos.containing(portalX, portalY, portalZ))) {
			if (world instanceof Level _level)
				ChampionslibraryPortalBlock.portalSpawn(_level, BlockPos.containing(portalX, portalY, portalZ));
