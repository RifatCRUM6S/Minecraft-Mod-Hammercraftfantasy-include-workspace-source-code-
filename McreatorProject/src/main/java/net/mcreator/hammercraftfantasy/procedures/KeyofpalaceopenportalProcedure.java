...
import net.mcreator.hammercraftfantasy.block.ChampionspalacePortalBlock;

public class KeyofpalaceopenportalProcedure {
	public static InteractionResult execute(LevelAccessor world, double x, double y, double z, Direction direction) {
		...
		if (world.isEmptyBlock(BlockPos.containing(portalX, portalY, portalZ))) {
			if (world instanceof Level _level)
				ChampionspalacePortalBlock.portalSpawn(_level, BlockPos.containing(portalX, portalY, portalZ));
