...
public class ModelBloodletter1<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "bloodletter1"), "main");
	...
	private final ModelPart hellblade;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition right_leg = partdefinition.addOrReplaceChild("right_leg",
				CubeListBuilder.create().texOffs(54, 14).addBox(-0.8371F, 11.0F, -4.7309F, 3.0F, 2.0F, 3.0F,
		...
		PartDefinition cube_r1 = right_leg.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(44, 45).addBox(-1.0F, -10.0F, -2.0F, 3.0F, 10.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r2 = right_leg.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(8, 45).addBox(-2.0F, -2.0F, -1.0F, 3.0F, 2.0F, 6.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r3 = right_leg.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(54, 6).addBox(-1.0F, -6.0F, -1.0F, 3.0F, 6.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.1629F, 11.0F, -2.7309F, -0.6981F, 0.0F, 0.0F));

		PartDefinition left_leg = partdefinition.addOrReplaceChild("left_leg",
				CubeListBuilder.create().texOffs(56, 48).addBox(-2.2501F, 11.0F, -5.7271F, 3.0F, 2.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.0F, 11.0F, 5.0F, 0.0F, -0.0873F, 0.0F));

		PartDefinition cube_r4 = left_leg.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(26, 45).addBox(-1.0F, -2.0F, -1.0F, 3.0F, 2.0F, 6.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r5 = left_leg.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(56, 40).addBox(-2.0F, -6.0F, -1.0F, 3.0F, 6.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r6 = left_leg.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(50, 21).addBox(-2.0F, -10.0F, -2.0F, 3.0F, 10.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.2501F, 5.0F, -5.7271F, -0.9163F, 0.0F, 0.0F));

		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(56, 53)
						.addBox(-1.0F, -8.0F, -2.0F, 2.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(42, 58)
						.addBox(-1.0F, -4.0F, -1.0F, 2.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 3.0F, 3.0F));

		PartDefinition cube_r7 = Body
				.addOrReplaceChild("cube_r7",
						CubeListBuilder.create().texOffs(0, 0).addBox(-5.0F, -9.0F, -2.0F, 10.0F, 9.0F, 6.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 2.0F, 0.0F, 0.6109F, 0.0F, 0.0F));

		PartDefinition cube_r8 = Body
				.addOrReplaceChild("cube_r8",
						CubeListBuilder.create().texOffs(0, 15).addBox(-4.0F, -6.0F, -1.0F, 8.0F, 6.0F, 5.0F,
								new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r9 = Head.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(32, 11).addBox(-2.0F, -2.0F, 0.0F, 6.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(6.0F, -9.0F, -2.0F, -0.0948F, -0.2228F, -1.2487F));

		PartDefinition cube_r10 = Head.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(54, 0).addBox(-1.0F, -3.0F, -1.0F, 5.0F, 3.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(8.0F, -5.0F, -3.0F, 0.0F, -0.3054F, -2.0508F));

		PartDefinition cube_r11 = Head.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(8, 53).addBox(-1.0F, -3.0F, -1.0F, 6.0F, 3.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.0F, 0.0F, -3.0F, 0.0094F, -0.0426F, -0.5238F));

		PartDefinition cube_r12 = Head
				.addOrReplaceChild("cube_r12",
						CubeListBuilder.create().texOffs(54, 19).addBox(0.0F, -2.0F, 1.0F, 4.0F, 1.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(2.0F, 3.0F, -4.0F, 0.0F, 0.0F, 0.48F));

		PartDefinition cube_r13 = Head
				.addOrReplaceChild("cube_r13",
						CubeListBuilder.create().texOffs(8, 42).addBox(-4.0F, -2.0F, 1.0F, 4.0F, 1.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(-2.0F, 3.0F, -4.0F, 0.0F, 0.0F, -0.48F));

		PartDefinition cube_r14 = Head.addOrReplaceChild("cube_r14",
				CubeListBuilder.create().texOffs(26, 21).addBox(-4.0F, -2.0F, 0.0F, 6.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-6.0F, -9.0F, -2.0F, -0.0948F, 0.2228F, 1.2487F));

		PartDefinition cube_r15 = Head.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(26, 53).addBox(-4.0F, -3.0F, -1.0F, 5.0F, 3.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-8.0F, -5.0F, -3.0F, 0.0F, 0.3054F, 2.0508F));

		PartDefinition cube_r16 = Head.addOrReplaceChild("cube_r16",
				CubeListBuilder.create().texOffs(50, 34).addBox(-5.0F, -3.0F, -1.0F, 6.0F, 3.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.0F, 0.0F, -3.0F, 0.0094F, 0.0426F, 0.5238F));

		PartDefinition cube_r17 = Head.addOrReplaceChild("cube_r17",
				CubeListBuilder.create().texOffs(0, 26).addBox(-3.0F, -13.0F, -4.0F, 6.0F, 13.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, -2.0F, -0.5236F, 0.0F, 0.0F));

		PartDefinition cube_r18 = Head
				.addOrReplaceChild("cube_r18",
						CubeListBuilder.create().texOffs(32, 0).addBox(-3.0F, -5.0F, -1.0F, 6.0F, 6.0F, 5.0F,
								new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r19 = right_arm.addOrReplaceChild("cube_r19",
				CubeListBuilder.create().texOffs(26, 15).addBox(-3.0F, -3.0F, -2.0F, 11.0F, 3.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r20 = right_arm.addOrReplaceChild("cube_r20",
				CubeListBuilder.create().texOffs(18, 32).addBox(-3.0F, -2.082F, -2.1495F, 4.0F, 9.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r21 = left_arm.addOrReplaceChild("cube_r21",
				CubeListBuilder.create().texOffs(18, 26).addBox(-8.0F, -3.0F, -2.0F, 11.0F, 3.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r22 = left_arm.addOrReplaceChild("cube_r22",
				CubeListBuilder.create().texOffs(34, 32).addBox(-1.0F, -2.082F, -2.1495F, 4.0F, 9.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, 0.0F, 0.0F, -0.2182F, 0.0F, 0.0F));

		PartDefinition hellblade = left_arm.addOrReplaceChild("hellblade", CubeListBuilder.create().texOffs(52, 58)
				.addBox(-0.0356F, -0.4281F, -0.4898F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 42)
				.addBox(0.9644F, -24.4281F, -0.4898F, 1.0F, 23.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(46, 21)
				.addBox(-0.0356F, -9.4281F, -0.4898F, 1.0F, 8.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(4, 42)
				.addBox(-1.0356F, -24.4281F, -0.4898F, 1.0F, 23.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.0F, 5.0F, -9.0F, 0.1195F, 1.0406F, 0.5685F));

		PartDefinition cube_r23 = hellblade.addOrReplaceChild("cube_r23",
				CubeListBuilder.create().texOffs(8, 59).addBox(0.0F, -4.0F, 0.0F, 1.0F, 5.0F, 1.0F,
						new CubeDeformation(0.0F)),
